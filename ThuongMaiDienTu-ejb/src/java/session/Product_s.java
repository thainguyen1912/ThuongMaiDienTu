...
import static entity.Product_.idcategory;
    ...
    public List<Product> getAll(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                Product pro=new Product(idProduct, productName, amount, BigInteger.valueOf(priceInput), BigInteger.valueOf(priceoutput), productImage, moreInfo, category);
                list_pro.add(pro);
            }
