...
<html lang="en">
    ...
    List<Product> list_laptop = (List<Product>) request.getAttribute("list_laptop");
    if (session.getAttribute("adminSess") != null) {
        session.removeAttribute("adminSess");
    }
    
    int d = list_laptop.size();
                ...
                <div class="home">
                    <div class="home_container d-flex flex-column align-items-center justify-content-end">
                        <div class="home_content text-center">
                            <div class="home_title">Laptop Page</div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image">
                                        <a href="">
                                            <img src="resources/home_page/images/product/<%=list_laptop.get(i).getProductimage()%>" alt="" width="320px" height="300px">
                                        </a>
                                    </div>
                                    <div class="product_content">
                                        <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                            <div>
                                                <div>
                                                    <div class="product_name"><a href="product.html"><%=list_laptop.get(i).getProductname()%></a></div>
                                                    <div class="product_category">In <a href="category.html">Category</a></div>
                                                </div>
                                            </div>
                                            <div class="ml-auto text-right">
                                                <div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                                <div class="product_price text-right"><%=list_laptop.get(i).getPriceoutput()%>vnđ</div>
                                            </div>
                                        </div>
                                        <a href="CheckLogin?page=check&idproduct=<%=list_laptop.get(i).getIdproduct()%>">    
