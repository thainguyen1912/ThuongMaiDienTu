 ...
 * @author thain
 */
@WebFilter(filterName = "All", urlPatterns = {"/Category",
    "/Product", "/Staff", "/Customer", "/AdminPage", "/CategoryControl"})
public class All implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpSession session = req.getSession();
                Staff sta = (Staff) session.getAttribute("adminSess");
                if (sta == null) {
                    req.setAttribute("filter_mess", "Bạn Phải Đăng Nhập Để Có Thể Truy Cập Trang Này");
                    RequestDispatcher rd = req.getRequestDispatcher("views/login_page/adminlogin.jsp");
