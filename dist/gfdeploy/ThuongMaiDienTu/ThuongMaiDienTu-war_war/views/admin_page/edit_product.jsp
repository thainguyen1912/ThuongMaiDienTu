                        ...
                        <div class="tab-content">
                            <div class="tab-pane tabs-animation fade active show" id="tab-content-1" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form class="" style="width: 100%" action="ProductControl?page=edit" method="post" enctype="multipart/form-data">
                                            <div>
                                                <div style="width: 60%; float: left">
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input value="<%=pro.getIdproduct()%>" name="idproduct" id="name" placeholder="" type="text" class="form-control" hidden="true">
                                                            <input value="<%=pro.getProductname() %>" name="productname" id="name" placeholder="" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="idcategory" class="form-control">
                                                                ...
                                                                %>
                                                                <option value="<%=list_cat.get(i).getIdcategory()%>" <%=list_cat.get(i).getIdcategory()==pro.getIdcategory().getIdcategory()?"selected":"" %>>
                                                                    <%=list_cat.get(i).getCategoryname()%>
                                                                </option>
                                                                <%}%>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input value="<%=pro.getAmountnow()%>" name="amountnow" id="name" placeholder="" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input value="<%=pro.getAmountpaid()%>" name="amountpaid" id="name" placeholder="" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input value="<%=pro.getPriceinput()%>" name="priceinput" id="name" placeholder="" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="position-relative row form-group">
                                                        <label for="priceoutput" class="col-sm-2 col-form-label">
                                                            Giá Bán Ra
                                                        </label>
                                                        <div class="col-sm-10">
                                                            <input value="<%=pro.getPriceoutput()%>" name="priceoutput" id="name" placeholder="" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="position-relative row form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea name="moreinfo" id="moreinfo" class="form-control"><%=pro.getMoreinfo()==null?"Không Có":pro.getMoreinfo() %></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div>
                                                        <div class="file-upload" style="width: 85%;">
                                                            <div style="margin-bottom: 10%">
                                                                <img style="max-width: 100%" src="resources/home_page/images/product/<%=pro.getProductimage()%>" alt="your image" />
                                                            </div>
